...
public class BusinessService {
    ...
    public void execute(BuildOrderBO buildOrder) {
        if (stockFeignClient.deduct(ProductStockDTO.builder().productId(buildOrder.getProductId()).stock(buildOrder.getStock()).build())) {
            ...
            if (orderFeignClient.order(
                    OrderDTO.builder()
                            .balance(buildOrder.getBalance())
                            .productId(buildOrder.getProductId())
                            .stock(buildOrder.getStock())
                            .userId(buildOrder.getUserId())
                            .build())) {
        ...
        System.out.println("this is empty business execute. " + buildOrder);
    }
}
